...
func (r *AccountResetNotifySettingsRequest) Encode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't encode %s as nil", "account.resetNotifySettings#db7e1747")
	}
...
func (r *AccountResetNotifySettingsRequest) Decode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't decode %s to nil", "account.resetNotifySettings#db7e1747")
	}
	if err := b.ConsumeID(AccountResetNotifySettingsRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "account.resetNotifySettings#db7e1747", err)
	}
