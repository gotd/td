...
func (g *GlobalPrivacySettings) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "globalPrivacySettings#bea2f424")
	}
...
func (g *GlobalPrivacySettings) EncodeBare(b *bin.Buffer) error {
	...
	if err := g.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "globalPrivacySettings#bea2f424", "flags", err)
	}
	if g.Flags.Has(0) {
...
func (g *GlobalPrivacySettings) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "globalPrivacySettings#bea2f424")
	}
	if err := b.ConsumeID(GlobalPrivacySettingsTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "globalPrivacySettings#bea2f424", err)
	}
...
func (g *GlobalPrivacySettings) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := g.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "globalPrivacySettings#bea2f424", "flags", err)
		}
	}
	if g.Flags.Has(0) {
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "globalPrivacySettings#bea2f424", "archive_and_mute_new_noncontact_peers", err)
		}
		g.ArchiveAndMuteNewNoncontactPeers = value
	}
	return nil
