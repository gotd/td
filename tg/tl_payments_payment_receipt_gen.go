...
// PaymentsPaymentReceipt represents TL type `payments.paymentReceipt#10b555d0`.
// Receipt
//
...
func (p *PaymentsPaymentReceipt) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "payments.paymentReceipt#10b555d0")
	}
...
func (p *PaymentsPaymentReceipt) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "flags", err)
	}
	b.PutInt(p.Date)
	b.PutInt(p.BotID)
	...
	if p.Flags.Has(2) {
		if p.Photo == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "payments.paymentReceipt#10b555d0", "photo")
		}
		if err := p.Photo.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "photo", err)
		}
	}
	if err := p.Invoice.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "invoice", err)
	}
	if p.Flags.Has(0) {
		if err := p.Info.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "info", err)
		}
	}
	if p.Flags.Has(1) {
		if err := p.Shipping.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "shipping", err)
		}
	}
	if p.Flags.Has(3) {
	...
	for idx, v := range p.Users {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "payments.paymentReceipt#10b555d0", "users", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "payments.paymentReceipt#10b555d0", "users", idx, err)
		}
	}
	return nil
}
...
func (p *PaymentsPaymentReceipt) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "payments.paymentReceipt#10b555d0")
	}
	if err := b.ConsumeID(PaymentsPaymentReceiptTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "payments.paymentReceipt#10b555d0", err)
	}
...
func (p *PaymentsPaymentReceipt) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "flags", err)
		}
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "date", err)
		}
		p.Date = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "bot_id", err)
		}
		p.BotID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "provider_id", err)
		}
		p.ProviderID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "title", err)
		}
		p.Title = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "description", err)
		}
		p.Description = value
	}
	if p.Flags.Has(2) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "photo", err)
		}
		p.Photo = value
	}
	{
		if err := p.Invoice.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "invoice", err)
		}
	}
	if p.Flags.Has(0) {
		if err := p.Info.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "info", err)
		}
	}
	if p.Flags.Has(1) {
		if err := p.Shipping.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "shipping", err)
		}
	}
	if p.Flags.Has(3) {
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "tip_amount", err)
		}
		p.TipAmount = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "currency", err)
		}
		p.Currency = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "total_amount", err)
		}
		p.TotalAmount = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "credentials_title", err)
		}
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "payments.paymentReceipt#10b555d0", "users", err)
		}
