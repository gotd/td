...
func (a *PhoneAcceptCallRequest) Encode(b *bin.Buffer) error {
	if a == nil {
		return fmt.Errorf("can't encode %s as nil", "phone.acceptCall#3bd2b4a0")
	}
...
func (a *PhoneAcceptCallRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := a.Peer.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phone.acceptCall#3bd2b4a0", "peer", err)
	}
	b.PutBytes(a.GB)
	if err := a.Protocol.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phone.acceptCall#3bd2b4a0", "protocol", err)
	}
	return nil
}
...
func (a *PhoneAcceptCallRequest) Decode(b *bin.Buffer) error {
	if a == nil {
		return fmt.Errorf("can't decode %s to nil", "phone.acceptCall#3bd2b4a0")
	}
	if err := b.ConsumeID(PhoneAcceptCallRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phone.acceptCall#3bd2b4a0", err)
	}
...
func (a *PhoneAcceptCallRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := a.Peer.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phone.acceptCall#3bd2b4a0", "peer", err)
		}
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phone.acceptCall#3bd2b4a0", "g_b", err)
		}
		a.GB = value
	}
	{
		if err := a.Protocol.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phone.acceptCall#3bd2b4a0", "protocol", err)
		}
	}
	return nil
}
