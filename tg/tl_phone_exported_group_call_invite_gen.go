...
func (e *PhoneExportedGroupCallInvite) Encode(b *bin.Buffer) error {
	if e == nil {
		return fmt.Errorf("can't encode %s as nil", "phone.exportedGroupCallInvite#204bd158")
	}
...
func (e *PhoneExportedGroupCallInvite) Decode(b *bin.Buffer) error {
	if e == nil {
		return fmt.Errorf("can't decode %s to nil", "phone.exportedGroupCallInvite#204bd158")
	}
	if err := b.ConsumeID(PhoneExportedGroupCallInviteTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phone.exportedGroupCallInvite#204bd158", err)
	}
...
func (e *PhoneExportedGroupCallInvite) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phone.exportedGroupCallInvite#204bd158", "link", err)
		}
		e.Link = value
	}
	return nil
