...
func (p *HelpPromoDataEmpty) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "help.promoDataEmpty#98f6ac75")
	}
...
func (p *HelpPromoDataEmpty) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "help.promoDataEmpty#98f6ac75")
	}
	if err := b.ConsumeID(HelpPromoDataEmptyTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "help.promoDataEmpty#98f6ac75", err)
	}
...
func (p *HelpPromoDataEmpty) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoDataEmpty#98f6ac75", "expires", err)
		}
		p.Expires = value
	}
	return nil
...
func (p *HelpPromoData) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "help.promoData#8c39793f")
	}
...
func (p *HelpPromoData) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "help.promoData#8c39793f", "flags", err)
	}
	b.PutInt(p.Expires)
	if p.Peer == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "help.promoData#8c39793f", "peer")
	}
	if err := p.Peer.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "help.promoData#8c39793f", "peer", err)
	}
	b.PutVectorHeader(len(p.Chats))
	for idx, v := range p.Chats {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "help.promoData#8c39793f", "chats", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "help.promoData#8c39793f", "chats", idx, err)
		}
	}
	b.PutVectorHeader(len(p.Users))
	for idx, v := range p.Users {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "help.promoData#8c39793f", "users", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "help.promoData#8c39793f", "users", idx, err)
		}
	}
	if p.Flags.Has(1) {
...
func (p *HelpPromoData) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "help.promoData#8c39793f")
	}
	if err := b.ConsumeID(HelpPromoDataTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "help.promoData#8c39793f", err)
	}
	return p.DecodeBare(b)
}
...
func (p *HelpPromoData) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "flags", err)
		}
	}
	p.Proxy = p.Flags.Has(0)
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "expires", err)
		}
		p.Expires = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "peer", err)
		}
		p.Peer = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "chats", err)
		}
	...
	}
	{
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "users", err)
		}
		for idx := 0; idx < headerLen; idx++ {
	...
	if p.Flags.Has(1) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "psa_type", err)
		}
		p.PsaType = value
	}
	if p.Flags.Has(2) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "help.promoData#8c39793f", "psa_message", err)
		}
		p.PsaMessage = value
	}
	return nil
...
func DecodeHelpPromoData(buf *bin.Buffer) (HelpPromoDataClass, error) {
	...
	case HelpPromoDataEmptyTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "HelpPromoDataClass", err)
		}
		return &v, nil
	case HelpPromoDataTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "HelpPromoDataClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *HelpPromoDataBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "HelpPromoData")
	}
...
func (b *HelpPromoDataBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.PromoData == nil {
		return fmt.Errorf("unable to encode %s as nil", "HelpPromoDataClass")
	}
