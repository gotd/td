...
func (i *InputStickerSetEmpty) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputStickerSetEmpty#ffb62b95",
		}
	}
...
func (i *InputStickerSetID) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputStickerSetID#9de7a269",
		}
	}
...
func (i *InputStickerSetShortName) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputStickerSetShortName#861cc8a0",
		}
	}
...
func (i *InputStickerSetAnimatedEmoji) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputStickerSetAnimatedEmoji#28703c8",
		}
	}
...
func (i *InputStickerSetDice) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputStickerSetDice#e67f520e",
		}
	}
