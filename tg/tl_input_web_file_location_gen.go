...
func (i *InputWebFileLocation) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputWebFileLocation#c239d686",
		}
	}
...
func (i *InputWebFileGeoPointLocation) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputWebFileGeoPointLocation#9f2221c9",
		}
	}
	...
	case InputWebFileLocationTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "InputWebFileLocationClass",
				Underlying: err,
			}
		}
		return &v, nil
...
func (b *InputWebFileLocationBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "decode",
			TypeName: "InputWebFileLocationBox",
		}
	}
