...
func (b *BotInlineMessageMediaAuto) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageMediaAuto#764cf810")
	}
...
func (b *BotInlineMessageMediaAuto) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "flags", err)
	}
	...
	if b.Flags.Has(1) {
		...
		for idx, v := range b.Entities {
			if v == nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "botInlineMessageMediaAuto#764cf810", "entities", idx)
			}
			if err := v.Encode(buf); err != nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "botInlineMessageMediaAuto#764cf810", "entities", idx, err)
			}
		}
	}
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaAuto#764cf810", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageMediaAuto) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageMediaAuto#764cf810")
	}
	if err := buf.ConsumeID(BotInlineMessageMediaAutoTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageMediaAuto#764cf810", err)
	}
...
func (b *BotInlineMessageMediaAuto) DecodeBare(buf *bin.Buffer) error {
	...
	}
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "flags", err)
		}
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "message", err)
		}
		b.Message = value
	}
	if b.Flags.Has(1) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "entities", err)
		}
	...
	if b.Flags.Has(2) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaAuto#764cf810", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func (b *BotInlineMessageText) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageText#8c7f65e2")
	}
...
func (b *BotInlineMessageText) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "flags", err)
	}
	buf.PutString(b.Message)
	if b.Flags.Has(1) {
		buf.PutVectorHeader(len(b.Entities))
		for idx, v := range b.Entities {
			if v == nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "botInlineMessageText#8c7f65e2", "entities", idx)
			}
			if err := v.Encode(buf); err != nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "botInlineMessageText#8c7f65e2", "entities", idx, err)
			}
		}
	}
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageText#8c7f65e2", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageText) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageText#8c7f65e2")
	}
	if err := buf.ConsumeID(BotInlineMessageTextTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageText#8c7f65e2", err)
	}
	return b.DecodeBare(buf)
}
...
func (b *BotInlineMessageText) DecodeBare(buf *bin.Buffer) error {
	...
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "flags", err)
		}
	}
	b.NoWebpage = b.Flags.Has(0)
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "message", err)
		}
		b.Message = value
	}
	if b.Flags.Has(1) {
		headerLen, err := buf.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "entities", err)
		}
		for idx := 0; idx < headerLen; idx++ {
			value, err := DecodeMessageEntity(buf)
			if err != nil {
	...
	if b.Flags.Has(2) {
		value, err := DecodeReplyMarkup(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageText#8c7f65e2", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func (b *BotInlineMessageMediaGeo) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageMediaGeo#51846fd")
	}
...
func (b *BotInlineMessageMediaGeo) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "flags", err)
	}
	if b.Geo == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaGeo#51846fd", "geo")
	}
	if err := b.Geo.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "geo", err)
	}
	if b.Flags.Has(0) {
	...
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaGeo#51846fd", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageMediaGeo) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageMediaGeo#51846fd")
	}
	if err := buf.ConsumeID(BotInlineMessageMediaGeoTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageMediaGeo#51846fd", err)
	}
	return b.DecodeBare(buf)
}
...
func (b *BotInlineMessageMediaGeo) DecodeBare(buf *bin.Buffer) error {
	...
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "flags", err)
		}
	}
	{
		value, err := DecodeGeoPoint(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "geo", err)
		}
		b.Geo = value
	}
	if b.Flags.Has(0) {
		value, err := buf.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "heading", err)
		}
		b.Heading = value
	}
	if b.Flags.Has(1) {
		value, err := buf.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "period", err)
		}
		b.Period = value
	}
	if b.Flags.Has(3) {
		value, err := buf.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "proximity_notification_radius", err)
		}
		b.ProximityNotificationRadius = value
	}
	if b.Flags.Has(2) {
		value, err := DecodeReplyMarkup(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaGeo#51846fd", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func (b *BotInlineMessageMediaVenue) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageMediaVenue#8a86659c")
	}
...
func (b *BotInlineMessageMediaVenue) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "flags", err)
	}
	if b.Geo == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaVenue#8a86659c", "geo")
	}
	if err := b.Geo.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "geo", err)
	}
	...
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaVenue#8a86659c", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageMediaVenue) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageMediaVenue#8a86659c")
	}
	if err := buf.ConsumeID(BotInlineMessageMediaVenueTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageMediaVenue#8a86659c", err)
	}
	return b.DecodeBare(buf)
}
...
func (b *BotInlineMessageMediaVenue) DecodeBare(buf *bin.Buffer) error {
	...
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "flags", err)
		}
	}
	{
		value, err := DecodeGeoPoint(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "geo", err)
		}
		b.Geo = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "title", err)
		}
		b.Title = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "address", err)
		}
		b.Address = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "provider", err)
		}
		b.Provider = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "venue_id", err)
		}
		b.VenueID = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "venue_type", err)
		}
		b.VenueType = value
	}
	if b.Flags.Has(2) {
		value, err := DecodeReplyMarkup(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaVenue#8a86659c", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func (b *BotInlineMessageMediaContact) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageMediaContact#18d1cdc2")
	}
...
func (b *BotInlineMessageMediaContact) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "flags", err)
	}
	...
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaContact#18d1cdc2", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageMediaContact) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageMediaContact#18d1cdc2")
	}
	if err := buf.ConsumeID(BotInlineMessageMediaContactTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageMediaContact#18d1cdc2", err)
	}
	return b.DecodeBare(buf)
}
...
func (b *BotInlineMessageMediaContact) DecodeBare(buf *bin.Buffer) error {
	...
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "flags", err)
		}
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "phone_number", err)
		}
		b.PhoneNumber = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "first_name", err)
		}
		b.FirstName = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "last_name", err)
		}
		b.LastName = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "vcard", err)
		}
		b.Vcard = value
	}
	if b.Flags.Has(2) {
		value, err := DecodeReplyMarkup(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaContact#18d1cdc2", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func (b *BotInlineMessageMediaInvoice) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "botInlineMessageMediaInvoice#354a9b09")
	}
...
func (b *BotInlineMessageMediaInvoice) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "flags", err)
	}
	buf.PutString(b.Title)
	buf.PutString(b.Description)
	if b.Flags.Has(0) {
		if b.Photo == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaInvoice#354a9b09", "photo")
		}
		if err := b.Photo.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "photo", err)
		}
	}
	...
	if b.Flags.Has(2) {
		if b.ReplyMarkup == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "botInlineMessageMediaInvoice#354a9b09", "reply_markup")
		}
		if err := b.ReplyMarkup.Encode(buf); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "reply_markup", err)
		}
	}
	return nil
}
...
func (b *BotInlineMessageMediaInvoice) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "botInlineMessageMediaInvoice#354a9b09")
	}
	if err := buf.ConsumeID(BotInlineMessageMediaInvoiceTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "botInlineMessageMediaInvoice#354a9b09", err)
	}
	return b.DecodeBare(buf)
}
...
func (b *BotInlineMessageMediaInvoice) DecodeBare(buf *bin.Buffer) error {
	...
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "flags", err)
		}
	}
	...
	b.Test = b.Flags.Has(3)
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "title", err)
		}
		b.Title = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "description", err)
		}
		b.Description = value
	}
	if b.Flags.Has(0) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "photo", err)
		}
		b.Photo = value
	}
	{
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "currency", err)
		}
		b.Currency = value
	}
	{
		value, err := buf.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "total_amount", err)
		}
		b.TotalAmount = value
	}
	if b.Flags.Has(2) {
		value, err := DecodeReplyMarkup(buf)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "botInlineMessageMediaInvoice#354a9b09", "reply_markup", err)
		}
		b.ReplyMarkup = value
	}
	return nil
...
func DecodeBotInlineMessage(buf *bin.Buffer) (BotInlineMessageClass, error) {
	...
	case BotInlineMessageMediaAutoTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "BotInlineMessageClass", err)
		}
		return &v, nil
	...
	case BotInlineMessageMediaInvoiceTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "BotInlineMessageClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *BotInlineMessageBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "BotInlineMessage")
	}
...
func (b *BotInlineMessageBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.BotInlineMessage == nil {
		return fmt.Errorf("unable to encode %s as nil", "BotInlineMessageClass")
	}
