...
func (p *PeerSettings) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "peerSettings#733f2961")
	}
...
func (p *PeerSettings) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "peerSettings#733f2961", "flags", err)
	}
	if p.Flags.Has(6) {
...
func (p *PeerSettings) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "peerSettings#733f2961")
	}
	if err := b.ConsumeID(PeerSettingsTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "peerSettings#733f2961", err)
	}
...
func (p *PeerSettings) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "peerSettings#733f2961", "flags", err)
		}
	}
	...
	if p.Flags.Has(6) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "peerSettings#733f2961", "geo_distance", err)
		}
		p.GeoDistance = value
	}
	return nil
