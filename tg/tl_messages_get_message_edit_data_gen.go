...
func (g *MessagesGetMessageEditDataRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "messages.getMessageEditData#fda68d36")
	}
...
func (g *MessagesGetMessageEditDataRequest) EncodeBare(b *bin.Buffer) error {
	...
	if g.Peer == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "messages.getMessageEditData#fda68d36", "peer")
	}
	if err := g.Peer.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "messages.getMessageEditData#fda68d36", "peer", err)
	}
	b.PutInt(g.ID)
	return nil
}
...
func (g *MessagesGetMessageEditDataRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "messages.getMessageEditData#fda68d36")
	}
	if err := b.ConsumeID(MessagesGetMessageEditDataRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "messages.getMessageEditData#fda68d36", err)
	}
...
func (g *MessagesGetMessageEditDataRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.getMessageEditData#fda68d36", "peer", err)
		}
		g.Peer = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.getMessageEditData#fda68d36", "id", err)
		}
		g.ID = value
	}
	return nil
