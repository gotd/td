...
func (p *PhoneCallEmpty) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCallEmpty#5366c915")
	}
...
func (p *PhoneCallEmpty) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCallEmpty#5366c915")
	}
	if err := b.ConsumeID(PhoneCallEmptyTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCallEmpty#5366c915", err)
	}
...
func (p *PhoneCallEmpty) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallEmpty#5366c915", "id", err)
		}
		p.ID = value
	}
	return nil
...
func (p *PhoneCallWaiting) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCallWaiting#1b8f4ad1")
	}
...
func (p *PhoneCallWaiting) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "flags", err)
	}
	b.PutLong(p.ID)
	...
	if err := p.Protocol.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "protocol", err)
	}
	if p.Flags.Has(0) {
...
func (p *PhoneCallWaiting) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCallWaiting#1b8f4ad1")
	}
	if err := b.ConsumeID(PhoneCallWaitingTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCallWaiting#1b8f4ad1", err)
	}
	return p.DecodeBare(b)
}
...
func (p *PhoneCallWaiting) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "flags", err)
		}
	}
	p.Video = p.Flags.Has(6)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "id", err)
		}
		p.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "access_hash", err)
		}
		p.AccessHash = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "date", err)
		}
		p.Date = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "admin_id", err)
		}
		p.AdminID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "participant_id", err)
		}
		p.ParticipantID = value
	}
	{
		if err := p.Protocol.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "protocol", err)
		}
	}
	if p.Flags.Has(0) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallWaiting#1b8f4ad1", "receive_date", err)
		}
		p.ReceiveDate = value
	}
	return nil
...
func (p *PhoneCallRequested) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCallRequested#87eabb53")
	}
...
func (p *PhoneCallRequested) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallRequested#87eabb53", "flags", err)
	}
	b.PutLong(p.ID)
	b.PutLong(p.AccessHash)
	b.PutInt(p.Date)
	...
	b.PutBytes(p.GAHash)
	if err := p.Protocol.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallRequested#87eabb53", "protocol", err)
	}
	return nil
}
...
func (p *PhoneCallRequested) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCallRequested#87eabb53")
	}
	if err := b.ConsumeID(PhoneCallRequestedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCallRequested#87eabb53", err)
	}
	return p.DecodeBare(b)
}
...
func (p *PhoneCallRequested) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "flags", err)
		}
	}
	p.Video = p.Flags.Has(6)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "id", err)
		}
		p.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "access_hash", err)
		}
		p.AccessHash = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "date", err)
		}
		p.Date = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "admin_id", err)
		}
		p.AdminID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "participant_id", err)
		}
		p.ParticipantID = value
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "g_a_hash", err)
		}
		p.GAHash = value
	}
	{
		if err := p.Protocol.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallRequested#87eabb53", "protocol", err)
		}
	}
	return nil
}
...
func (p *PhoneCallAccepted) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCallAccepted#997c454a")
	}
...
func (p *PhoneCallAccepted) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallAccepted#997c454a", "flags", err)
	}
	b.PutLong(p.ID)
	b.PutLong(p.AccessHash)
	b.PutInt(p.Date)
	...
	b.PutBytes(p.GB)
	if err := p.Protocol.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallAccepted#997c454a", "protocol", err)
	}
	return nil
}
...
func (p *PhoneCallAccepted) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCallAccepted#997c454a")
	}
	if err := b.ConsumeID(PhoneCallAcceptedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCallAccepted#997c454a", err)
	}
	return p.DecodeBare(b)
}
...
func (p *PhoneCallAccepted) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "flags", err)
		}
	}
	p.Video = p.Flags.Has(6)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "id", err)
		}
		p.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "access_hash", err)
		}
		p.AccessHash = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "date", err)
		}
		p.Date = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "admin_id", err)
		}
		p.AdminID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "participant_id", err)
		}
		p.ParticipantID = value
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "g_b", err)
		}
		p.GB = value
	}
	{
		if err := p.Protocol.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallAccepted#997c454a", "protocol", err)
		}
	}
	return nil
}
...
func (p *PhoneCall) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCall#8742ae7f")
	}
...
func (p *PhoneCall) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCall#8742ae7f", "flags", err)
	}
	b.PutLong(p.ID)
	b.PutLong(p.AccessHash)
	b.PutInt(p.Date)
	...
	if err := p.Protocol.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCall#8742ae7f", "protocol", err)
	}
	b.PutVectorHeader(len(p.Connections))
	for idx, v := range p.Connections {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "phoneCall#8742ae7f", "connections", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "phoneCall#8742ae7f", "connections", idx, err)
		}
	}
...
func (p *PhoneCall) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCall#8742ae7f")
	}
	if err := b.ConsumeID(PhoneCallTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCall#8742ae7f", err)
	}
	return p.DecodeBare(b)
}
...
func (p *PhoneCall) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "flags", err)
		}
	}
	...
	p.Video = p.Flags.Has(6)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "id", err)
		}
		p.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "access_hash", err)
		}
		p.AccessHash = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "date", err)
		}
		p.Date = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "admin_id", err)
		}
		p.AdminID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "participant_id", err)
		}
		p.ParticipantID = value
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "g_a_or_b", err)
		}
		p.GAOrB = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "key_fingerprint", err)
		}
		p.KeyFingerprint = value
	}
	{
		if err := p.Protocol.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "protocol", err)
		}
	}
	{
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "connections", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCall#8742ae7f", "start_date", err)
		}
		p.StartDate = value
	}
	return nil
...
func (p *PhoneCallDiscarded) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "phoneCallDiscarded#50ca4de1")
	}
...
func (p *PhoneCallDiscarded) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "flags", err)
	}
	b.PutLong(p.ID)
	if p.Flags.Has(0) {
		if p.Reason == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "phoneCallDiscarded#50ca4de1", "reason")
		}
		if err := p.Reason.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "reason", err)
		}
	}
	if p.Flags.Has(1) {
		b.PutInt(p.Duration)
...
func (p *PhoneCallDiscarded) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "phoneCallDiscarded#50ca4de1")
	}
	if err := b.ConsumeID(PhoneCallDiscardedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phoneCallDiscarded#50ca4de1", err)
	}
	return p.DecodeBare(b)
}
...
func (p *PhoneCallDiscarded) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "flags", err)
		}
	}
	...
	p.Video = p.Flags.Has(6)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "id", err)
		}
		p.ID = value
	}
	if p.Flags.Has(0) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "reason", err)
		}
		p.Reason = value
	}
	if p.Flags.Has(1) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phoneCallDiscarded#50ca4de1", "duration", err)
		}
		p.Duration = value
	}
	return nil
...
func DecodePhoneCall(buf *bin.Buffer) (PhoneCallClass, error) {
	...
	case PhoneCallEmptyTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "PhoneCallClass", err)
		}
		return &v, nil
	...
	case PhoneCallDiscardedTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "PhoneCallClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *PhoneCallBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "PhoneCall")
	}
...
func (b *PhoneCallBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.PhoneCall == nil {
		return fmt.Errorf("unable to encode %s as nil", "PhoneCallClass")
	}
