...
func (b *MessagesBotCallbackAnswer) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode %s as nil", "messages.botCallbackAnswer#36585ea4")
	}
...
func (b *MessagesBotCallbackAnswer) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Flags.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "messages.botCallbackAnswer#36585ea4", "flags", err)
	}
	if b.Flags.Has(0) {
...
func (b *MessagesBotCallbackAnswer) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode %s to nil", "messages.botCallbackAnswer#36585ea4")
	}
	if err := buf.ConsumeID(MessagesBotCallbackAnswerTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "messages.botCallbackAnswer#36585ea4", err)
	}
...
func (b *MessagesBotCallbackAnswer) DecodeBare(buf *bin.Buffer) error {
	...
	}
	{
		if err := b.Flags.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.botCallbackAnswer#36585ea4", "flags", err)
		}
	}
	...
	if b.Flags.Has(0) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.botCallbackAnswer#36585ea4", "message", err)
		}
		b.Message = value
	}
	if b.Flags.Has(2) {
		value, err := buf.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.botCallbackAnswer#36585ea4", "url", err)
		}
		b.URL = value
	}
	{
		value, err := buf.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.botCallbackAnswer#36585ea4", "cache_time", err)
		}
		b.CacheTime = value
	}
	return nil
