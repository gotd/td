...
func (g *MessagesGetScheduledHistoryRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "messages.getScheduledHistory#e2c2685b")
	}
...
func (g *MessagesGetScheduledHistoryRequest) EncodeBare(b *bin.Buffer) error {
	...
	if g.Peer == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "messages.getScheduledHistory#e2c2685b", "peer")
	}
	if err := g.Peer.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "messages.getScheduledHistory#e2c2685b", "peer", err)
	}
	b.PutInt(g.Hash)
	return nil
}
...
func (g *MessagesGetScheduledHistoryRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "messages.getScheduledHistory#e2c2685b")
	}
	if err := b.ConsumeID(MessagesGetScheduledHistoryRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "messages.getScheduledHistory#e2c2685b", err)
	}
...
func (g *MessagesGetScheduledHistoryRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.getScheduledHistory#e2c2685b", "peer", err)
		}
		g.Peer = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.getScheduledHistory#e2c2685b", "hash", err)
		}
		g.Hash = value
	}
	return nil
