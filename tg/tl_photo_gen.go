...
func (p *PhotoEmpty) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "photoEmpty#2331b22d")
	}
...
func (p *PhotoEmpty) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "photoEmpty#2331b22d")
	}
	if err := b.ConsumeID(PhotoEmptyTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "photoEmpty#2331b22d", err)
	}
...
func (p *PhotoEmpty) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photoEmpty#2331b22d", "id", err)
		}
		p.ID = value
	}
	return nil
...
func (p *Photo) Encode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't encode %s as nil", "photo#fb197a65")
	}
	b.PutID(PhotoTypeID)
	return p.EncodeBare(b)
}
...
func (p *Photo) EncodeBare(b *bin.Buffer) error {
	...
	if err := p.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "photo#fb197a65", "flags", err)
	}
	b.PutLong(p.ID)
	...
	for idx, v := range p.Sizes {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "photo#fb197a65", "sizes", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "photo#fb197a65", "sizes", idx, err)
		}
	}
	if p.Flags.Has(1) {
		...
		for idx, v := range p.VideoSizes {
			if err := v.Encode(b); err != nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "photo#fb197a65", "video_sizes", idx, err)
			}
		}
	}
	b.PutInt(p.DCID)
...
func (p *Photo) Decode(b *bin.Buffer) error {
	if p == nil {
		return fmt.Errorf("can't decode %s to nil", "photo#fb197a65")
	}
	if err := b.ConsumeID(PhotoTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "photo#fb197a65", err)
	}
	return p.DecodeBare(b)
}
...
func (p *Photo) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := p.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "flags", err)
		}
	}
	p.HasStickers = p.Flags.Has(0)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "id", err)
		}
		p.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "access_hash", err)
		}
		p.AccessHash = value
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "file_reference", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "date", err)
		}
		p.Date = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "sizes", err)
		}
	...
	if p.Flags.Has(1) {
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "video_sizes", err)
		}
		for idx := 0; idx < headerLen; idx++ {
			var value VideoSize
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "photo#fb197a65", "dc_id", err)
		}
		p.DCID = value
	}
	return nil
...
func DecodePhoto(buf *bin.Buffer) (PhotoClass, error) {
	...
	case PhotoEmptyTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "PhotoClass", err)
		}
		return &v, nil
	case PhotoTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "PhotoClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *PhotoBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "Photo")
	}
...
func (b *PhotoBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.Photo == nil {
		return fmt.Errorf("unable to encode %s as nil", "PhotoClass")
	}
