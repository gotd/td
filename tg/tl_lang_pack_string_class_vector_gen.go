...
func (vec *LangPackStringClassVector) Encode(b *bin.Buffer) error {
	if vec == nil {
		return fmt.Errorf("can't encode %s as nil", "Vector<LangPackString>")
	}
...
func (vec *LangPackStringClassVector) EncodeBare(b *bin.Buffer) error {
	...
	for idx, v := range vec.Elems {
		if v == nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d is nil", "Vector<LangPackString>", "Elems", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "Vector<LangPackString>", "Elems", idx, err)
		}
	}
	return nil
}
...
func (vec *LangPackStringClassVector) Decode(b *bin.Buffer) error {
	if vec == nil {
		return fmt.Errorf("can't decode %s to nil", "Vector<LangPackString>")
	}
...
func (vec *LangPackStringClassVector) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "Vector<LangPackString>", "Elems", err)
		}
