...
func (c *AuthCodeTypeSMS) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "auth.codeTypeSms#72a3158c")
	}
...
func (c *AuthCodeTypeSMS) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "auth.codeTypeSms#72a3158c")
	}
	if err := b.ConsumeID(AuthCodeTypeSMSTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "auth.codeTypeSms#72a3158c", err)
	}
...
func (c *AuthCodeTypeCall) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "auth.codeTypeCall#741cd3e3")
	}
...
func (c *AuthCodeTypeCall) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "auth.codeTypeCall#741cd3e3")
	}
	if err := b.ConsumeID(AuthCodeTypeCallTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "auth.codeTypeCall#741cd3e3", err)
	}
	return c.DecodeBare(b)
}
...
func (c *AuthCodeTypeFlashCall) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "auth.codeTypeFlashCall#226ccefb")
	}
...
func (c *AuthCodeTypeFlashCall) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "auth.codeTypeFlashCall#226ccefb")
	}
	if err := b.ConsumeID(AuthCodeTypeFlashCallTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "auth.codeTypeFlashCall#226ccefb", err)
	}
	return c.DecodeBare(b)
}
...
func DecodeAuthCodeType(buf *bin.Buffer) (AuthCodeTypeClass, error) {
	...
	case AuthCodeTypeSMSTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "AuthCodeTypeClass", err)
		}
		return &v, nil
	...
	case AuthCodeTypeFlashCallTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "AuthCodeTypeClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *AuthCodeTypeBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "AuthCodeType")
	}
...
func (b *AuthCodeTypeBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.CodeType == nil {
		return fmt.Errorf("unable to encode %s as nil", "AuthCodeTypeClass")
	}
