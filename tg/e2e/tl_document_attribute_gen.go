...
func (d *DocumentAttributeImageSize) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeImageSize#6c37c15c",
		}
	}
...
func (d *DocumentAttributeAnimated) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeAnimated#11b58939",
		}
	}
...
func (d *DocumentAttributeSticker23) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeSticker23#fb0a5727",
		}
	}
...
func (d *DocumentAttributeVideo) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeVideo#5910cccb",
		}
	}
...
func (d *DocumentAttributeAudio23) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeAudio23#51448e5",
		}
	}
...
func (d *DocumentAttributeFilename) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeFilename#15590068",
		}
	}
...
func (d *DocumentAttributeAudio45) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeAudio45#ded218e0",
		}
	}
...
func (d *DocumentAttributeSticker) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeSticker#3a556302",
		}
	}
...
func (d *DocumentAttributeAudio) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeAudio#9852f9c6",
		}
	}
...
func (d *DocumentAttributeVideo66) Encode(b *bin.Buffer) error {
	if d == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "documentAttributeVideo66#ef02ce6",
		}
	}
	...
	case DocumentAttributeImageSizeTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "DocumentAttributeClass",
				Underlying: err,
			}
		}
		return &v, nil
