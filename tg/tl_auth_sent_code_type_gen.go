...
func (s *AuthSentCodeTypeApp) Encode(b *bin.Buffer) error {
	if s == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "auth.sentCodeTypeApp#3dbb5986",
		}
	}
...
func (s *AuthSentCodeTypeSMS) Encode(b *bin.Buffer) error {
	if s == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "auth.sentCodeTypeSms#c000bba2",
		}
	}
...
func (s *AuthSentCodeTypeCall) Encode(b *bin.Buffer) error {
	if s == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "auth.sentCodeTypeCall#5353e5a7",
		}
	}
...
func (s *AuthSentCodeTypeFlashCall) Encode(b *bin.Buffer) error {
	if s == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "auth.sentCodeTypeFlashCall#ab03c6d9",
		}
	}
	...
	case AuthSentCodeTypeAppTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "AuthSentCodeTypeClass",
				Underlying: err,
			}
		}
		return &v, nil
