...
func (i *InputWallPaper) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputWallPaper#e630b979",
		}
	}
...
func (i *InputWallPaperSlug) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputWallPaperSlug#72091c80",
		}
	}
...
func (i *InputWallPaperNoFile) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputWallPaperNoFile#967a462e",
		}
	}
