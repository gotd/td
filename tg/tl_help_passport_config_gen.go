...
func (p *HelpPassportConfigNotModified) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "help.passportConfigNotModified#bfb9f457",
		}
	}
...
func (p *HelpPassportConfig) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "help.passportConfig#a098d6af",
		}
	}
	...
	case HelpPassportConfigNotModifiedTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "HelpPassportConfigClass",
				Underlying: err,
			}
		}
		return &v, nil
...
func (b *HelpPassportConfigBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "decode",
			TypeName: "HelpPassportConfigBox",
		}
	}
