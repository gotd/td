...
func TypesMap() map[uint32]string {
	return map[uint32]string{
		...
		InputMediaPaidMediaTypeID:                                "inputMediaPaidMedia#aa661fc3",
		...
		StarsTransactionTypeID:                                                  "starsTransaction#2db5418f",
		...
		PaymentsGetStarsTransactionsRequestTypeID:                               "payments.getStarsTransactions#97938d5a",
		...
		StoriesSearchPostsRequestTypeID:                                         "stories.searchPosts#6cea116a",
