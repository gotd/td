...
func (r *AccountResetWallPapersRequest) Encode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't encode %s as nil", "account.resetWallPapers#bb3b9804")
	}
...
func (r *AccountResetWallPapersRequest) Decode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't decode %s to nil", "account.resetWallPapers#bb3b9804")
	}
	if err := b.ConsumeID(AccountResetWallPapersRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "account.resetWallPapers#bb3b9804", err)
	}
