...
// StarGift represents TL type `starGift#bcff5b`.
...
func (s *StarGift) Encode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't encode starGift#bcff5b as nil")
	}
...
func (s *StarGift) EncodeBare(b *bin.Buffer) error {
	...
	if err := s.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode starGift#bcff5b: field flags: %w", err)
	}
	b.PutLong(s.ID)
	if s.Sticker == nil {
		return fmt.Errorf("unable to encode starGift#bcff5b: field sticker is nil")
	}
	if err := s.Sticker.Encode(b); err != nil {
		return fmt.Errorf("unable to encode starGift#bcff5b: field sticker: %w", err)
	}
	b.PutLong(s.Stars)
	if s.Flags.Has(0) {
	...
	if s.Flags.Has(6) {
		if s.ReleasedBy == nil {
			return fmt.Errorf("unable to encode starGift#bcff5b: field released_by is nil")
		}
		if err := s.ReleasedBy.Encode(b); err != nil {
			return fmt.Errorf("unable to encode starGift#bcff5b: field released_by: %w", err)
		}
	}
	if s.Flags.Has(8) {
...
func (s *StarGift) Decode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't decode starGift#bcff5b to nil")
	}
	if err := b.ConsumeID(StarGiftTypeID); err != nil {
		return fmt.Errorf("unable to decode starGift#bcff5b: %w", err)
	}
...
func (s *StarGift) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := s.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field flags: %w", err)
		}
	}
	...
	s.LimitedPerUser = s.Flags.Has(8)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field id: %w", err)
		}
		s.ID = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field sticker: %w", err)
		}
		s.Sticker = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field stars: %w", err)
		}
		s.Stars = value
	}
	if s.Flags.Has(0) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field availability_remains: %w", err)
		}
	...
	if s.Flags.Has(0) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field availability_total: %w", err)
		}
	...
	if s.Flags.Has(4) {
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field availability_resale: %w", err)
		}
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field convert_stars: %w", err)
		}
	...
	if s.Flags.Has(1) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field first_sale_date: %w", err)
		}
	...
	if s.Flags.Has(1) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field last_sale_date: %w", err)
		}
	...
	if s.Flags.Has(3) {
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field upgrade_stars: %w", err)
		}
	...
	if s.Flags.Has(4) {
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field resell_min_stars: %w", err)
		}
	...
	if s.Flags.Has(5) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field title: %w", err)
		}
		s.Title = value
	}
	if s.Flags.Has(6) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field released_by: %w", err)
		}
		s.ReleasedBy = value
	}
	if s.Flags.Has(8) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field per_user_total: %w", err)
		}
	...
	if s.Flags.Has(8) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGift#bcff5b: field per_user_remains: %w", err)
		}
...
// StarGiftUnique represents TL type `starGiftUnique#3a274d50`.
//
...
const StarGiftUniqueTypeID = 0x3a274d50
...
func (s *StarGiftUnique) Encode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't encode starGiftUnique#3a274d50 as nil")
	}
...
func (s *StarGiftUnique) EncodeBare(b *bin.Buffer) error {
	...
	s.SetFlags()
	if err := s.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field flags: %w", err)
	}
	b.PutLong(s.ID)
	b.PutString(s.Title)
	b.PutString(s.Slug)
	...
	if s.Flags.Has(0) {
		if s.OwnerID == nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field owner_id is nil")
		}
		if err := s.OwnerID.Encode(b); err != nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field owner_id: %w", err)
		}
	}
	if s.Flags.Has(1) {
	...
	for idx, v := range s.Attributes {
		if v == nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field attributes element with index %d is nil", idx)
		}
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field attributes element with index %d: %w", idx, err)
		}
	}
	...
	if s.Flags.Has(4) {
		...
		for idx, v := range s.ResellAmount {
			if v == nil {
				return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field resell_amount element with index %d is nil", idx)
			}
			if err := v.Encode(b); err != nil {
				return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field resell_amount element with index %d: %w", idx, err)
			}
		}
	}
	if s.Flags.Has(5) {
		if s.ReleasedBy == nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field released_by is nil")
		}
		if err := s.ReleasedBy.Encode(b); err != nil {
			return fmt.Errorf("unable to encode starGiftUnique#3a274d50: field released_by: %w", err)
		}
	}
	return nil
}
...
func (s *StarGiftUnique) Decode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't decode starGiftUnique#3a274d50 to nil")
	}
	if err := b.ConsumeID(StarGiftUniqueTypeID); err != nil {
		return fmt.Errorf("unable to decode starGiftUnique#3a274d50: %w", err)
	}
	return s.DecodeBare(b)
}
...
func (s *StarGiftUnique) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := s.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field flags: %w", err)
		}
	}
	...
	s.ResaleTonOnly = s.Flags.Has(7)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field id: %w", err)
		}
		s.ID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field title: %w", err)
		}
		s.Title = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field slug: %w", err)
		}
		s.Slug = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field num: %w", err)
		}
		s.Num = value
	}
	if s.Flags.Has(0) {
		value, err := DecodePeer(b)
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field owner_id: %w", err)
		}
		s.OwnerID = value
	}
	if s.Flags.Has(1) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field owner_name: %w", err)
		}
		s.OwnerName = value
	}
	if s.Flags.Has(2) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field owner_address: %w", err)
		}
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field attributes: %w", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field availability_issued: %w", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field availability_total: %w", err)
		}
		s.AvailabilityTotal = value
	}
	if s.Flags.Has(3) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field gift_address: %w", err)
		}
		s.GiftAddress = value
	}
	if s.Flags.Has(4) {
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field resell_amount: %w", err)
		}
	...
	if s.Flags.Has(5) {
		value, err := DecodePeer(b)
		if err != nil {
			return fmt.Errorf("unable to decode starGiftUnique#3a274d50: field released_by: %w", err)
		}
		s.ReleasedBy = value
	}
	return nil
...
//	}
//	switch v := g.(type) {
//	case *tg.StarGift: // starGift#bcff5b
//	case *tg.StarGiftUnique: // starGiftUnique#3a274d50
//	default: panic(v)
//	}
...
func DecodeStarGift(buf *bin.Buffer) (StarGiftClass, error) {
	...
	case StarGiftUniqueTypeID:
		// Decoding starGiftUnique#3a274d50.
		v := StarGiftUnique{}
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode StarGiftClass: %w", err)
		}
