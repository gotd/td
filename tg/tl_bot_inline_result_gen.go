...
func (b *BotInlineResult) Encode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "botInlineResult#11965f3a",
		}
	}
...
func (b *BotInlineMediaResult) Encode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "botInlineMediaResult#17db940b",
		}
	}
