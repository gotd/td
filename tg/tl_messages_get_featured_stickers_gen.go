...
func (g *MessagesGetFeaturedStickersRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "messages.getFeaturedStickers#2dacca4f")
	}
...
func (g *MessagesGetFeaturedStickersRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "messages.getFeaturedStickers#2dacca4f")
	}
	if err := b.ConsumeID(MessagesGetFeaturedStickersRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "messages.getFeaturedStickers#2dacca4f", err)
	}
...
func (g *MessagesGetFeaturedStickersRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.getFeaturedStickers#2dacca4f", "hash", err)
		}
		g.Hash = value
	}
	return nil
