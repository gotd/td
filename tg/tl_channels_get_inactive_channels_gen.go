...
func (g *ChannelsGetInactiveChannelsRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "channels.getInactiveChannels#11e831ee")
	}
...
func (g *ChannelsGetInactiveChannelsRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "channels.getInactiveChannels#11e831ee")
	}
	if err := b.ConsumeID(ChannelsGetInactiveChannelsRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "channels.getInactiveChannels#11e831ee", err)
	}
