...
func (i *InputEncryptedFileEmpty) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "inputEncryptedFileEmpty#1837c364")
	}
...
func (i *InputEncryptedFileEmpty) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "inputEncryptedFileEmpty#1837c364")
	}
	if err := b.ConsumeID(InputEncryptedFileEmptyTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "inputEncryptedFileEmpty#1837c364", err)
	}
...
func (i *InputEncryptedFileUploaded) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "inputEncryptedFileUploaded#64bd0306")
	}
...
func (i *InputEncryptedFileUploaded) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "inputEncryptedFileUploaded#64bd0306")
	}
	if err := b.ConsumeID(InputEncryptedFileUploadedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "inputEncryptedFileUploaded#64bd0306", err)
	}
	return i.DecodeBare(b)
}
...
func (i *InputEncryptedFileUploaded) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileUploaded#64bd0306", "id", err)
		}
		i.ID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileUploaded#64bd0306", "parts", err)
		}
		i.Parts = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileUploaded#64bd0306", "md5_checksum", err)
		}
		i.MD5Checksum = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileUploaded#64bd0306", "key_fingerprint", err)
		}
...
func (i *InputEncryptedFile) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "inputEncryptedFile#5a17b5e5")
	}
...
func (i *InputEncryptedFile) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "inputEncryptedFile#5a17b5e5")
	}
	if err := b.ConsumeID(InputEncryptedFileTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "inputEncryptedFile#5a17b5e5", err)
	}
	return i.DecodeBare(b)
}
...
func (i *InputEncryptedFile) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFile#5a17b5e5", "id", err)
		}
		i.ID = value
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFile#5a17b5e5", "access_hash", err)
		}
		i.AccessHash = value
	}
	return nil
...
func (i *InputEncryptedFileBigUploaded) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "inputEncryptedFileBigUploaded#2dc173c8")
	}
...
func (i *InputEncryptedFileBigUploaded) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "inputEncryptedFileBigUploaded#2dc173c8")
	}
	if err := b.ConsumeID(InputEncryptedFileBigUploadedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "inputEncryptedFileBigUploaded#2dc173c8", err)
	}
	return i.DecodeBare(b)
}
...
func (i *InputEncryptedFileBigUploaded) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileBigUploaded#2dc173c8", "id", err)
		}
		i.ID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileBigUploaded#2dc173c8", "parts", err)
		}
		i.Parts = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputEncryptedFileBigUploaded#2dc173c8", "key_fingerprint", err)
		}
		i.KeyFingerprint = value
	}
	return nil
...
func DecodeInputEncryptedFile(buf *bin.Buffer) (InputEncryptedFileClass, error) {
	...
	case InputEncryptedFileEmptyTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "InputEncryptedFileClass", err)
		}
		return &v, nil
	...
	case InputEncryptedFileBigUploadedTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "InputEncryptedFileClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *InputEncryptedFileBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "InputEncryptedFile")
	}
...
func (b *InputEncryptedFileBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.InputEncryptedFile == nil {
		return fmt.Errorf("unable to encode %s as nil", "InputEncryptedFileClass")
	}
