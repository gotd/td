...
func (g *ContactsGetTopPeersRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "contacts.getTopPeers#d4982db5")
	}
...
func (g *ContactsGetTopPeersRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := g.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "contacts.getTopPeers#d4982db5", "flags", err)
	}
	b.PutInt(g.Offset)
	b.PutInt(g.Limit)
	b.PutInt(g.Hash)
...
func (g *ContactsGetTopPeersRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "contacts.getTopPeers#d4982db5")
	}
	if err := b.ConsumeID(ContactsGetTopPeersRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "contacts.getTopPeers#d4982db5", err)
	}
...
func (g *ContactsGetTopPeersRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := g.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "contacts.getTopPeers#d4982db5", "flags", err)
		}
	}
	...
	g.Channels = g.Flags.Has(15)
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "contacts.getTopPeers#d4982db5", "offset", err)
		}
		g.Offset = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "contacts.getTopPeers#d4982db5", "limit", err)
		}
		g.Limit = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "contacts.getTopPeers#d4982db5", "hash", err)
		}
		g.Hash = value
	}
	return nil
