...
func (s *MessagesSetBotCallbackAnswerRequest) Encode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't encode %s as nil", "messages.setBotCallbackAnswer#d58f130a")
	}
...
func (s *MessagesSetBotCallbackAnswerRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := s.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "flags", err)
	}
	b.PutLong(s.QueryID)
	if s.Flags.Has(0) {
...
func (s *MessagesSetBotCallbackAnswerRequest) Decode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't decode %s to nil", "messages.setBotCallbackAnswer#d58f130a")
	}
	if err := b.ConsumeID(MessagesSetBotCallbackAnswerRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "messages.setBotCallbackAnswer#d58f130a", err)
	}
...
func (s *MessagesSetBotCallbackAnswerRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := s.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "flags", err)
		}
	}
	s.Alert = s.Flags.Has(1)
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "query_id", err)
		}
		s.QueryID = value
	}
	if s.Flags.Has(0) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "message", err)
		}
		s.Message = value
	}
	if s.Flags.Has(2) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "url", err)
		}
		s.URL = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "messages.setBotCallbackAnswer#d58f130a", "cache_time", err)
		}
		s.CacheTime = value
	}
	return nil
