...
func (p *PhoneCallDiscardReasonMissed) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "phoneCallDiscardReasonMissed#85e42301",
		}
	}
...
func (p *PhoneCallDiscardReasonDisconnect) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "phoneCallDiscardReasonDisconnect#e095c1a0",
		}
	}
...
func (p *PhoneCallDiscardReasonHangup) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "phoneCallDiscardReasonHangup#57adc690",
		}
	}
...
func (p *PhoneCallDiscardReasonBusy) Encode(b *bin.Buffer) error {
	if p == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "phoneCallDiscardReasonBusy#faf7e8c9",
		}
	}
	...
	case PhoneCallDiscardReasonMissedTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "PhoneCallDiscardReasonClass",
				Underlying: err,
			}
		}
		return &v, nil
...
func (b *PhoneCallDiscardReasonBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "decode",
			TypeName: "PhoneCallDiscardReasonBox",
		}
	}
