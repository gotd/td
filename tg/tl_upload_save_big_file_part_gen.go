...
func (s *UploadSaveBigFilePartRequest) Encode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't encode %s as nil", "upload.saveBigFilePart#de7b673d")
	}
...
func (s *UploadSaveBigFilePartRequest) Decode(b *bin.Buffer) error {
	if s == nil {
		return fmt.Errorf("can't decode %s to nil", "upload.saveBigFilePart#de7b673d")
	}
	if err := b.ConsumeID(UploadSaveBigFilePartRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "upload.saveBigFilePart#de7b673d", err)
	}
...
func (s *UploadSaveBigFilePartRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "upload.saveBigFilePart#de7b673d", "file_id", err)
		}
		s.FileID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "upload.saveBigFilePart#de7b673d", "file_part", err)
		}
		s.FilePart = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "upload.saveBigFilePart#de7b673d", "file_total_parts", err)
		}
	...
	}
	{
		value, err := b.Bytes()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "upload.saveBigFilePart#de7b673d", "bytes", err)
		}
		s.Bytes = value
	}
	return nil
