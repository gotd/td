...
func (n *NotifyBroadcasts) Encode(b *bin.Buffer) error {
	if n == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "notifyBroadcasts#d612e8ef",
		}
	}
