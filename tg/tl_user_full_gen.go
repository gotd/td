...
func (u *UserFull) Encode(b *bin.Buffer) error {
	if u == nil {
		return fmt.Errorf("can't encode %s as nil", "userFull#139a9a77")
	}
...
func (u *UserFull) EncodeBare(b *bin.Buffer) error {
	...
	if err := u.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "flags", err)
	}
	if u.User == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "userFull#139a9a77", "user")
	}
	if err := u.User.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "user", err)
	}
	if u.Flags.Has(1) {
		b.PutString(u.About)
	}
	if err := u.Settings.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "settings", err)
	}
	if u.Flags.Has(2) {
		if u.ProfilePhoto == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "userFull#139a9a77", "profile_photo")
		}
		if err := u.ProfilePhoto.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "profile_photo", err)
		}
	}
	if err := u.NotifySettings.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "notify_settings", err)
	}
	if u.Flags.Has(3) {
		if err := u.BotInfo.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "userFull#139a9a77", "bot_info", err)
		}
	}
	if u.Flags.Has(6) {
...
func (u *UserFull) Decode(b *bin.Buffer) error {
	if u == nil {
		return fmt.Errorf("can't decode %s to nil", "userFull#139a9a77")
	}
	if err := b.ConsumeID(UserFullTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "userFull#139a9a77", err)
	}
...
func (u *UserFull) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := u.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "flags", err)
		}
	}
	...
	u.VideoCallsAvailable = u.Flags.Has(13)
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "user", err)
		}
		u.User = value
	}
	if u.Flags.Has(1) {
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "about", err)
		}
		u.About = value
	}
	{
		if err := u.Settings.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "settings", err)
		}
	}
	if u.Flags.Has(2) {
		value, err := DecodePhoto(b)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "profile_photo", err)
		}
		u.ProfilePhoto = value
	}
	{
		if err := u.NotifySettings.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "notify_settings", err)
		}
	}
	if u.Flags.Has(3) {
		if err := u.BotInfo.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "bot_info", err)
		}
	}
	if u.Flags.Has(6) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "pinned_msg_id", err)
		}
		u.PinnedMsgID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "common_chats_count", err)
		}
	...
	if u.Flags.Has(11) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "folder_id", err)
		}
		u.FolderID = value
	}
	if u.Flags.Has(14) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "userFull#139a9a77", "ttl_period", err)
		}
		u.TTLPeriod = value
	}
	return nil
