...
func (r *PhoneReceivedCallRequest) Encode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't encode %s as nil", "phone.receivedCall#17d54f61")
	}
...
func (r *PhoneReceivedCallRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := r.Peer.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "phone.receivedCall#17d54f61", "peer", err)
	}
	return nil
}
...
func (r *PhoneReceivedCallRequest) Decode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't decode %s to nil", "phone.receivedCall#17d54f61")
	}
	if err := b.ConsumeID(PhoneReceivedCallRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "phone.receivedCall#17d54f61", err)
	}
...
func (r *PhoneReceivedCallRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := r.Peer.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "phone.receivedCall#17d54f61", "peer", err)
		}
	}
	return nil
}
