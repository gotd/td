...
func (m *MessageMediaGeo) String() string {
	...
	sb.WriteString("{\n")
	sb.WriteString("\tGeo: ")
	sb.WriteString(fmt.Sprint(m.Geo))
	sb.WriteString(",\n")
	sb.WriteString("}")
	return sb.String()
}
...
func (m *MessageMediaDocument) String() string {
	...
	if m.Flags.Has(0) {
		...
		sb.WriteString(fmt.Sprint(m.Document))
		sb.WriteString(",\n")
	}
	if m.Flags.Has(2) {
		sb.WriteString("\tTTLSeconds: ")
...
func (m *MessageMediaWebPage) String() string {
	...
	sb.WriteString(fmt.Sprint(m.Webpage))
	sb.WriteString(",\n")
	sb.WriteString("}")
	return sb.String()
}
...
func (m *MessageMediaGame) String() string {
	...
	sb.WriteString("{\n")
	sb.WriteString("\tGame: ")
	sb.WriteString(fmt.Sprint(m.Game))
	sb.WriteString(",\n")
	sb.WriteString("}")
	return sb.String()
}
...
func (m *MessageMediaPoll) String() string {
	...
	sb.WriteString("{\n")
	sb.WriteString("\tPoll: ")
	sb.WriteString(fmt.Sprint(m.Poll))
	sb.WriteString(",\n")
