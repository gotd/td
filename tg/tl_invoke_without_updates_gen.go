...
func (i *InvokeWithoutUpdatesRequest) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "invokeWithoutUpdates#bf9459b7")
	}
...
func (i *InvokeWithoutUpdatesRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := i.Query.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "invokeWithoutUpdates#bf9459b7", "query", err)
	}
	return nil
}
...
func (i *InvokeWithoutUpdatesRequest) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "invokeWithoutUpdates#bf9459b7")
	}
	if err := b.ConsumeID(InvokeWithoutUpdatesRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "invokeWithoutUpdates#bf9459b7", err)
	}
...
func (i *InvokeWithoutUpdatesRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := i.Query.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "invokeWithoutUpdates#bf9459b7", "query", err)
		}
	}
	return nil
}
