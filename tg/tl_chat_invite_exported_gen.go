...
func (c *ChatInviteExported) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "chatInviteExported#6e24fc9d")
	}
...
func (c *ChatInviteExported) EncodeBare(b *bin.Buffer) error {
	...
	if err := c.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "chatInviteExported#6e24fc9d", "flags", err)
	}
	b.PutString(c.Link)
	b.PutInt(c.AdminID)
	b.PutInt(c.Date)
...
func (c *ChatInviteExported) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "chatInviteExported#6e24fc9d")
	}
	if err := b.ConsumeID(ChatInviteExportedTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "chatInviteExported#6e24fc9d", err)
	}
...
func (c *ChatInviteExported) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := c.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "flags", err)
		}
	}
	...
	c.Permanent = c.Flags.Has(5)
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "link", err)
		}
		c.Link = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "admin_id", err)
		}
		c.AdminID = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "date", err)
		}
		c.Date = value
	}
	if c.Flags.Has(4) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "start_date", err)
		}
		c.StartDate = value
	}
	if c.Flags.Has(1) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "expire_date", err)
		}
		c.ExpireDate = value
	}
	if c.Flags.Has(2) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "usage_limit", err)
		}
		c.UsageLimit = value
	}
	if c.Flags.Has(3) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatInviteExported#6e24fc9d", "usage", err)
		}
		c.Usage = value
	}
	return nil
