...
func (i *InputBotInlineMessageMediaAuto) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageMediaAuto#3380c786",
		}
	}
...
func (i *InputBotInlineMessageText) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageText#3dcd7a87",
		}
	}
...
func (i *InputBotInlineMessageMediaGeo) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageMediaGeo#96929a85",
		}
	}
...
func (i *InputBotInlineMessageMediaVenue) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageMediaVenue#417bbf11",
		}
	}
...
func (i *InputBotInlineMessageMediaContact) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageMediaContact#a6edbffd",
		}
	}
...
func (i *InputBotInlineMessageGame) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageGame#4b425864",
		}
	}
...
func (i *InputBotInlineMessageMediaInvoice) Encode(b *bin.Buffer) error {
	if i == nil {
		return &bin.NilError{
			Action:   "encode",
			TypeName: "inputBotInlineMessageMediaInvoice#d7e78225",
		}
	}
	...
	case InputBotInlineMessageMediaAutoTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, &bin.DecodeError{
				TypeName:   "InputBotInlineMessageClass",
				Underlying: err,
			}
		}
		return &v, nil
...
func (b *InputBotInlineMessageBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return &bin.NilError{
			Action:   "decode",
			TypeName: "InputBotInlineMessageBox",
		}
	}
