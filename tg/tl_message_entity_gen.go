...
func (i *InputMessageEntityMentionName) Encode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't encode %s as nil", "inputMessageEntityMentionName#208e68c9")
	}
...
func (i *InputMessageEntityMentionName) EncodeBare(b *bin.Buffer) error {
	...
	b.PutInt(i.Length)
	if i.UserID == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "inputMessageEntityMentionName#208e68c9", "user_id")
	}
	if err := i.UserID.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "inputMessageEntityMentionName#208e68c9", "user_id", err)
	}
	return nil
}
...
func (i *InputMessageEntityMentionName) Decode(b *bin.Buffer) error {
	if i == nil {
		return fmt.Errorf("can't decode %s to nil", "inputMessageEntityMentionName#208e68c9")
	}
	if err := b.ConsumeID(InputMessageEntityMentionNameTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "inputMessageEntityMentionName#208e68c9", err)
	}
...
func (i *InputMessageEntityMentionName) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputMessageEntityMentionName#208e68c9", "offset", err)
		}
		i.Offset = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputMessageEntityMentionName#208e68c9", "length", err)
		}
		i.Length = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "inputMessageEntityMentionName#208e68c9", "user_id", err)
		}
		i.UserID = value
	}
	return nil
