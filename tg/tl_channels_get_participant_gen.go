...
func (g *ChannelsGetParticipantRequest) Encode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't encode %s as nil", "channels.getParticipant#a0ab6cc6")
	}
...
func (g *ChannelsGetParticipantRequest) EncodeBare(b *bin.Buffer) error {
	...
	if g.Channel == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "channels.getParticipant#a0ab6cc6", "channel")
	}
	if err := g.Channel.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "channels.getParticipant#a0ab6cc6", "channel", err)
	}
	if g.Participant == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "channels.getParticipant#a0ab6cc6", "participant")
	}
	if err := g.Participant.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "channels.getParticipant#a0ab6cc6", "participant", err)
	}
	return nil
}
...
func (g *ChannelsGetParticipantRequest) Decode(b *bin.Buffer) error {
	if g == nil {
		return fmt.Errorf("can't decode %s to nil", "channels.getParticipant#a0ab6cc6")
	}
	if err := b.ConsumeID(ChannelsGetParticipantRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "channels.getParticipant#a0ab6cc6", err)
	}
...
func (g *ChannelsGetParticipantRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channels.getParticipant#a0ab6cc6", "channel", err)
		}
		g.Channel = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channels.getParticipant#a0ab6cc6", "participant", err)
		}
		g.Participant = value
	}
	return nil
