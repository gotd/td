...
// ChatFull represents TL type `chatFull#8a1e2983`.
// Detailed chat info
//
...
const ChatFullTypeID = 0x8a1e2983
...
func (c *ChatFull) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "chatFull#8a1e2983")
	}
...
func (c *ChatFull) EncodeBare(b *bin.Buffer) error {
	...
	if err := c.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "flags", err)
	}
	b.PutInt(c.ID)
	b.PutString(c.About)
	if c.Participants == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "chatFull#8a1e2983", "participants")
	}
	if err := c.Participants.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "participants", err)
	}
	if c.Flags.Has(2) {
		if c.ChatPhoto == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "chatFull#8a1e2983", "chat_photo")
		}
		if err := c.ChatPhoto.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "chat_photo", err)
		}
	}
	if err := c.NotifySettings.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "notify_settings", err)
	}
	if c.Flags.Has(13) {
		if err := c.ExportedInvite.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "exported_invite", err)
		}
	}
	if c.Flags.Has(3) {
		...
		for idx, v := range c.BotInfo {
			if err := v.Encode(b); err != nil {
				return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "chatFull#8a1e2983", "bot_info", idx, err)
			}
		}
	}
	if c.Flags.Has(6) {
	...
	if c.Flags.Has(12) {
		if err := c.Call.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "call", err)
		}
	}
	if c.Flags.Has(14) {
	...
	if c.Flags.Has(15) {
		if c.GroupcallDefaultJoinAs == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "chatFull#8a1e2983", "groupcall_default_join_as")
		}
		if err := c.GroupcallDefaultJoinAs.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "chatFull#8a1e2983", "groupcall_default_join_as", err)
		}
	}
	return nil
}
...
func (c *ChatFull) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "chatFull#8a1e2983")
	}
	if err := b.ConsumeID(ChatFullTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "chatFull#8a1e2983", err)
	}
...
func (c *ChatFull) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		if err := c.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "flags", err)
		}
	}
	...
	c.HasScheduled = c.Flags.Has(8)
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "id", err)
		}
		c.ID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "about", err)
		}
		c.About = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "participants", err)
		}
	...
	if c.Flags.Has(2) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "chat_photo", err)
		}
		c.ChatPhoto = value
	}
	{
		if err := c.NotifySettings.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "notify_settings", err)
		}
	}
	if c.Flags.Has(13) {
		if err := c.ExportedInvite.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "exported_invite", err)
		}
	}
	if c.Flags.Has(3) {
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "bot_info", err)
		}
	...
	if c.Flags.Has(6) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "pinned_msg_id", err)
		}
		c.PinnedMsgID = value
	}
	if c.Flags.Has(11) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "folder_id", err)
		}
		c.FolderID = value
	}
	if c.Flags.Has(12) {
		if err := c.Call.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "call", err)
		}
	}
	if c.Flags.Has(14) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "ttl_period", err)
		}
		c.TTLPeriod = value
	}
	if c.Flags.Has(15) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "chatFull#8a1e2983", "groupcall_default_join_as", err)
		}
		c.GroupcallDefaultJoinAs = value
	}
	return nil
...
// ChannelFull represents TL type `channelFull#548c3f93`.
...
const ChannelFullTypeID = 0x548c3f93
...
func (c *ChannelFull) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode %s as nil", "channelFull#548c3f93")
	}
...
func (c *ChannelFull) EncodeBare(b *bin.Buffer) error {
	...
	if err := c.Flags.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "flags", err)
	}
	b.PutInt(c.ID)
	b.PutString(c.About)
	if c.Flags.Has(0) {
	...
	if c.ChatPhoto == nil {
		return fmt.Errorf("unable to encode %s: field %s is nil", "channelFull#548c3f93", "chat_photo")
	}
	if err := c.ChatPhoto.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "chat_photo", err)
	}
	if err := c.NotifySettings.Encode(b); err != nil {
		return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "notify_settings", err)
	}
	if c.Flags.Has(23) {
		if err := c.ExportedInvite.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "exported_invite", err)
		}
	}
	b.PutVectorHeader(len(c.BotInfo))
	for idx, v := range c.BotInfo {
		if err := v.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s element with index %d: %w", "channelFull#548c3f93", "bot_info", idx, err)
		}
	}
	if c.Flags.Has(4) {
	...
	if c.Flags.Has(8) {
		if err := c.Stickerset.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "stickerset", err)
		}
	}
	if c.Flags.Has(9) {
	...
	if c.Flags.Has(15) {
		if c.Location == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "channelFull#548c3f93", "location")
		}
		if err := c.Location.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "location", err)
		}
	}
	if c.Flags.Has(17) {
	...
	if c.Flags.Has(21) {
		if err := c.Call.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "call", err)
		}
	}
	if c.Flags.Has(24) {
		b.PutInt(c.TTLPeriod)
	...
	if c.Flags.Has(26) {
		if c.GroupcallDefaultJoinAs == nil {
			return fmt.Errorf("unable to encode %s: field %s is nil", "channelFull#548c3f93", "groupcall_default_join_as")
		}
		if err := c.GroupcallDefaultJoinAs.Encode(b); err != nil {
			return fmt.Errorf("unable to encode %s: field %s: %w", "channelFull#548c3f93", "groupcall_default_join_as", err)
		}
	}
	return nil
}
...
func (c *ChannelFull) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode %s to nil", "channelFull#548c3f93")
	}
	if err := b.ConsumeID(ChannelFullTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "channelFull#548c3f93", err)
	}
	return c.DecodeBare(b)
}
...
func (c *ChannelFull) DecodeBare(b *bin.Buffer) error {
	...
	{
		if err := c.Flags.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "flags", err)
		}
	}
	...
	c.Blocked = c.Flags.Has(22)
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "id", err)
		}
		c.ID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "about", err)
		}
		c.About = value
	}
	if c.Flags.Has(0) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "participants_count", err)
		}
		c.ParticipantsCount = value
	}
	if c.Flags.Has(1) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "admins_count", err)
		}
		c.AdminsCount = value
	}
	if c.Flags.Has(2) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "kicked_count", err)
		}
		c.KickedCount = value
	}
	if c.Flags.Has(2) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "banned_count", err)
		}
		c.BannedCount = value
	}
	if c.Flags.Has(13) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "online_count", err)
		}
		c.OnlineCount = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "read_inbox_max_id", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "read_outbox_max_id", err)
		}
	...
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "unread_count", err)
		}
		c.UnreadCount = value
	}
	{
		value, err := DecodePhoto(b)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "chat_photo", err)
		}
		c.ChatPhoto = value
	}
	{
		if err := c.NotifySettings.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "notify_settings", err)
		}
	}
	if c.Flags.Has(23) {
		if err := c.ExportedInvite.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "exported_invite", err)
		}
	}
	{
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "bot_info", err)
		}
		for idx := 0; idx < headerLen; idx++ {
			var value BotInfo
			if err := value.Decode(b); err != nil {
	...
	if c.Flags.Has(4) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "migrated_from_chat_id", err)
		}
		c.MigratedFromChatID = value
	}
	if c.Flags.Has(4) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "migrated_from_max_id", err)
		}
		c.MigratedFromMaxID = value
	}
	if c.Flags.Has(5) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "pinned_msg_id", err)
		}
		c.PinnedMsgID = value
	}
	if c.Flags.Has(8) {
		if err := c.Stickerset.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "stickerset", err)
		}
	}
	if c.Flags.Has(9) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "available_min_id", err)
		}
		c.AvailableMinID = value
	}
	if c.Flags.Has(11) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "folder_id", err)
		}
		c.FolderID = value
	}
	if c.Flags.Has(14) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "linked_chat_id", err)
		}
		c.LinkedChatID = value
	}
	if c.Flags.Has(15) {
		...
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "location", err)
		}
		c.Location = value
	}
	if c.Flags.Has(17) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "slowmode_seconds", err)
		}
		c.SlowmodeSeconds = value
	}
	if c.Flags.Has(18) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "slowmode_next_send_date", err)
		}
		c.SlowmodeNextSendDate = value
	}
	if c.Flags.Has(12) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "stats_dc", err)
		}
		c.StatsDC = value
	}
	{
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "pts", err)
		}
		c.Pts = value
	}
	if c.Flags.Has(21) {
		if err := c.Call.Decode(b); err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "call", err)
		}
	}
	if c.Flags.Has(24) {
		value, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "ttl_period", err)
		}
		c.TTLPeriod = value
	}
	if c.Flags.Has(25) {
		headerLen, err := b.VectorHeader()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "pending_suggestions", err)
		}
		for idx := 0; idx < headerLen; idx++ {
			value, err := b.String()
			if err != nil {
	...
	if c.Flags.Has(26) {
		value, err := DecodePeer(b)
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "channelFull#548c3f93", "groupcall_default_join_as", err)
		}
		c.GroupcallDefaultJoinAs = value
	}
	return nil
...
//  }
//  switch v := g.(type) {
//  case *tg.ChatFull: // chatFull#8a1e2983
//  case *tg.ChannelFull: // channelFull#548c3f93
//  default: panic(v)
//  }
...
func DecodeChatFull(buf *bin.Buffer) (ChatFullClass, error) {
	...
	switch id {
	case ChatFullTypeID:
		// Decoding chatFull#8a1e2983.
		v := ChatFull{}
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "ChatFullClass", err)
		}
		return &v, nil
	case ChannelFullTypeID:
		// Decoding channelFull#548c3f93.
		v := ChannelFull{}
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "ChatFullClass", err)
		}
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "ChatFullClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *ChatFullBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "ChatFull")
	}
...
func (b *ChatFullBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.ChatFull == nil {
		return fmt.Errorf("unable to encode %s as nil", "ChatFullClass")
	}
