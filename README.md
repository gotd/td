...
* Voice and video [calls](https://pkg.go.dev/github.com/gotd/td/telegram/calls) (tgcalls), both 1:1 and group calls — see the [call](examples/call) and [groupcall](examples/groupcall) examples
