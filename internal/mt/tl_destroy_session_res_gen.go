...
func (d *DestroySessionOk) Encode(b *bin.Buffer) error {
	if d == nil {
		return fmt.Errorf("can't encode %s as nil", "destroy_session_ok#e22045fc")
	}
...
func (d *DestroySessionOk) Decode(b *bin.Buffer) error {
	if d == nil {
		return fmt.Errorf("can't decode %s to nil", "destroy_session_ok#e22045fc")
	}
	if err := b.ConsumeID(DestroySessionOkTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "destroy_session_ok#e22045fc", err)
	}
...
func (d *DestroySessionOk) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "destroy_session_ok#e22045fc", "session_id", err)
		}
		d.SessionID = value
	}
	return nil
...
func (d *DestroySessionNone) Encode(b *bin.Buffer) error {
	if d == nil {
		return fmt.Errorf("can't encode %s as nil", "destroy_session_none#62d350c9")
	}
...
func (d *DestroySessionNone) Decode(b *bin.Buffer) error {
	if d == nil {
		return fmt.Errorf("can't decode %s to nil", "destroy_session_none#62d350c9")
	}
	if err := b.ConsumeID(DestroySessionNoneTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "destroy_session_none#62d350c9", err)
	}
	return d.DecodeBare(b)
}
...
func (d *DestroySessionNone) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "destroy_session_none#62d350c9", "session_id", err)
		}
		d.SessionID = value
	}
	return nil
...
func DecodeDestroySessionRes(buf *bin.Buffer) (DestroySessionResClass, error) {
	...
	case DestroySessionOkTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode %s: %w", "DestroySessionResClass", err)
		}
		return &v, nil
	case DestroySessionNoneTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode %s: %w", "DestroySessionResClass", bin.NewUnexpectedID(id))
	}
}
...
func (b *DestroySessionResBox) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("unable to decode %sBox to nil", "DestroySessionRes")
	}
...
func (b *DestroySessionResBox) Encode(buf *bin.Buffer) error {
	if b == nil || b.DestroySessionRes == nil {
		return fmt.Errorf("unable to encode %s as nil", "DestroySessionResClass")
	}
