...
// construct implements constructor of ServerDHParams.
func (s ServerDHParamsFail) construct() ServerDHParams { return &s }
...
var (
	...
	_ ServerDHParams = &ServerDHParamsFail{}
)
...
// construct implements constructor of ServerDHParams.
func (s ServerDHParamsOk) construct() ServerDHParams { return &s }
...
var (
	...
	_ ServerDHParams = &ServerDHParamsOk{}
)

// ServerDHParams represents ServerDHParams generic type.
//
// Example:
...
type ServerDHParams interface {
	bin.Encoder
	bin.Decoder
	construct() ServerDHParams
}

// DecodeServerDHParams implements binary de-serialization for ServerDHParams.
func DecodeServerDHParams(buf *bin.Buffer) (ServerDHParams, error) {
	id, err := buf.PeekID()
	if err != nil {
		return nil, err
	}
	...
	case ServerDHParamsFailTypeID:
		...
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode ServerDHParams: %w", err)
		}
		return &v, nil
	case ServerDHParamsOkTypeID:
		...
		return &v, nil
	default:
		return nil, fmt.Errorf("unable to decode ServerDHParams: %w", bin.NewUnexpectedID(id))
	}
}
