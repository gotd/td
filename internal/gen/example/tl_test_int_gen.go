...
func (t *TestInt) Encode(b *bin.Buffer) error {
	if t == nil {
		return fmt.Errorf("can't encode %s as nil", "testInt#ddbd2c09")
	}
...
func (t *TestInt) Decode(b *bin.Buffer) error {
	if t == nil {
		return fmt.Errorf("can't decode %s to nil", "testInt#ddbd2c09")
	}
	if err := b.ConsumeID(TestIntTypeID); err != nil {
		return fmt.Errorf("unable to decode %s: %w", "testInt#ddbd2c09", err)
	}
...
func (t *TestInt) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode %s: field %s: %w", "testInt#ddbd2c09", "value", err)
		}
		t.Value = value
	}
	return nil
