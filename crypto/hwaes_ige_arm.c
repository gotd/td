...
// IGE decrypt, gotd convention: c=iv[:16] (previous ciphertext),
// m=iv[16:] (previous plaintext). len must be a multiple of 16.
// Returns 0 on success, -1 if hardware AES is unavailable, -2 on bad length.
