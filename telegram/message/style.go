...
type StyledTextOption struct {
	size    int
	perform func(builder *textBuilder)
}

func styledTextOption(s string, perform func(builder *textBuilder)) StyledTextOption {
...
func Plain(s string) StyledTextOption {
	return styledTextOption(s, func(b *textBuilder) {
		b.Plain(s)
	})
}
