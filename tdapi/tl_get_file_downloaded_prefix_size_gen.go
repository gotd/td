...
func (g *GetFileDownloadedPrefixSizeRequest) EncodeTDLibJSON(b jsontd.Encoder) error {
	if g == nil {
		return fmt.Errorf("can't encode getFileDownloadedPrefixSize#9c8724a0 as nil")
	}
	b.ObjStart()
...
func (g *GetFileDownloadedPrefixSizeRequest) DecodeTDLibJSON(b jsontd.Decoder) error {
	if g == nil {
		return fmt.Errorf("can't decode getFileDownloadedPrefixSize#9c8724a0 to nil")
	}
