...
func (g *GetCallbackQueryAnswerRequest) EncodeTDLibJSON(b jsontd.Encoder) error {
	if g == nil {
		return fmt.Errorf("can't encode getCallbackQueryAnswer#6ef7a5f as nil")
	}
	b.ObjStart()
...
func (g *GetCallbackQueryAnswerRequest) DecodeTDLibJSON(b jsontd.Decoder) error {
	if g == nil {
		return fmt.Errorf("can't decode getCallbackQueryAnswer#6ef7a5f to nil")
	}
