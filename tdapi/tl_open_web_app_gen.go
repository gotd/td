...
const OpenWebAppRequestTypeID = 0xd27a3533
...
func (o *OpenWebAppRequest) Encode(b *bin.Buffer) error {
	if o == nil {
		return fmt.Errorf("can't encode openWebApp#d27a3533 as nil")
	}
...
func (o *OpenWebAppRequest) EncodeBare(b *bin.Buffer) error {
	...
	if err := o.Theme.Encode(b); err != nil {
		return fmt.Errorf("unable to encode openWebApp#d27a3533: field theme: %w", err)
	}
...
func (o *OpenWebAppRequest) Decode(b *bin.Buffer) error {
	if o == nil {
		return fmt.Errorf("can't decode openWebApp#d27a3533 to nil")
	}
	if err := b.ConsumeID(OpenWebAppRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode openWebApp#d27a3533: %w", err)
	}
...
func (o *OpenWebAppRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field chat_id: %w", err)
		}
		o.ChatID = value
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field bot_user_id: %w", err)
		}
		o.BotUserID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field url: %w", err)
		}
		o.URL = value
	}
	{
		if err := o.Theme.Decode(b); err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field theme: %w", err)
		}
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field application_name: %w", err)
		}
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field message_thread_id: %w", err)
		}
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode openWebApp#d27a3533: field reply_to_message_id: %w", err)
		}
...
// OpenWebApp invokes method openWebApp#d27a3533 returning error if any.
