...
func (s *SetVoiceChatDefaultParticipantRequest) EncodeTDLibJSON(b tdjson.Encoder) error {
	if s == nil {
		return fmt.Errorf("can't encode setVoiceChatDefaultParticipant#1f51ee9d as nil")
	}
	b.ObjStart()
...
func (s *SetVoiceChatDefaultParticipantRequest) DecodeTDLibJSON(b tdjson.Decoder) error {
	if s == nil {
		return fmt.Errorf("can't decode setVoiceChatDefaultParticipant#1f51ee9d to nil")
	}
