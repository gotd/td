...
// User represents TL type `user#cd8cf8ac`.
type User struct {
	// User identifier
	ID int64
...
func (u *User) Encode(b *bin.Buffer) error {
	if u == nil {
		return fmt.Errorf("can't encode user#cd8cf8ac as nil")
	}
	b.PutID(UserTypeID)
...
func (u *User) EncodeBare(b *bin.Buffer) error {
	...
	if err := u.Usernames.Encode(b); err != nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field usernames: %w", err)
	}
	b.PutString(u.PhoneNumber)
	if u.Status == nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field status is nil")
	}
	if err := u.Status.Encode(b); err != nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field status: %w", err)
	}
	if err := u.ProfilePhoto.Encode(b); err != nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field profile_photo: %w", err)
	}
	...
	if err := u.EmojiStatus.Encode(b); err != nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field emoji_status: %w", err)
	}
	...
	if u.Type == nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field type is nil")
	}
	if err := u.Type.Encode(b); err != nil {
		return fmt.Errorf("unable to encode user#cd8cf8ac: field type: %w", err)
	}
...
func (u *User) Decode(b *bin.Buffer) error {
	if u == nil {
		return fmt.Errorf("can't decode user#cd8cf8ac to nil")
	}
	if err := b.ConsumeID(UserTypeID); err != nil {
		return fmt.Errorf("unable to decode user#cd8cf8ac: %w", err)
	}
...
func (u *User) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field id: %w", err)
		}
		u.ID = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field first_name: %w", err)
		}
		u.FirstName = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field last_name: %w", err)
		}
		u.LastName = value
	}
	{
		if err := u.Usernames.Decode(b); err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field usernames: %w", err)
		}
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field phone_number: %w", err)
		}
		u.PhoneNumber = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field status: %w", err)
		}
		u.Status = value
	}
	{
		if err := u.ProfilePhoto.Decode(b); err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field profile_photo: %w", err)
		}
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field accent_color_id: %w", err)
		}
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field background_custom_emoji_id: %w", err)
		}
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field profile_accent_color_id: %w", err)
		}
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field profile_background_custom_emoji_id: %w", err)
		}
		u.ProfileBackgroundCustomEmojiID = value
	}
	{
		if err := u.EmojiStatus.Decode(b); err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field emoji_status: %w", err)
		}
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_contact: %w", err)
		}
		u.IsContact = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_mutual_contact: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_close_friend: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_verified: %w", err)
		}
		u.IsVerified = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_premium: %w", err)
		}
		u.IsPremium = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_support: %w", err)
		}
		u.IsSupport = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field restriction_reason: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_scam: %w", err)
		}
		u.IsScam = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field is_fake: %w", err)
		}
		u.IsFake = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field has_active_stories: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field has_unread_active_stories: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field have_access: %w", err)
		}
		u.HaveAccess = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field type: %w", err)
		}
		u.Type = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field language_code: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode user#cd8cf8ac: field added_to_attachment_menu: %w", err)
		}
