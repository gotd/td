...
// BusinessInfo represents TL type `businessInfo#773c5066`.
...
const BusinessInfoTypeID = 0x773c5066
...
func (b *BusinessInfo) Encode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't encode businessInfo#773c5066 as nil")
	}
...
func (b *BusinessInfo) EncodeBare(buf *bin.Buffer) error {
	...
	if err := b.Location.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode businessInfo#773c5066: field location: %w", err)
	}
	if err := b.OpeningHours.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode businessInfo#773c5066: field opening_hours: %w", err)
	}
	if err := b.GreetingMessageSettings.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode businessInfo#773c5066: field greeting_message_settings: %w", err)
	}
	if err := b.AwayMessageSettings.Encode(buf); err != nil {
		return fmt.Errorf("unable to encode businessInfo#773c5066: field away_message_settings: %w", err)
	}
	return nil
}
...
func (b *BusinessInfo) Decode(buf *bin.Buffer) error {
	if b == nil {
		return fmt.Errorf("can't decode businessInfo#773c5066 to nil")
	}
	if err := buf.ConsumeID(BusinessInfoTypeID); err != nil {
		return fmt.Errorf("unable to decode businessInfo#773c5066: %w", err)
	}
...
func (b *BusinessInfo) DecodeBare(buf *bin.Buffer) error {
	...
	}
	{
		if err := b.Location.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode businessInfo#773c5066: field location: %w", err)
		}
	}
	{
		if err := b.OpeningHours.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode businessInfo#773c5066: field opening_hours: %w", err)
		}
	}
	{
		if err := b.GreetingMessageSettings.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode businessInfo#773c5066: field greeting_message_settings: %w", err)
		}
	}
	{
		if err := b.AwayMessageSettings.Decode(buf); err != nil {
			return fmt.Errorf("unable to decode businessInfo#773c5066: field away_message_settings: %w", err)
		}
	}
	return nil
}
