...
type GetStorageStatisticsRequest struct {
	...
	// statistics should be returned. All other chats will be grouped in entries with chat_id
	// == 0. If the chat info database is not used, the chat_limit is ignored and is always
	// set to 0
	ChatLimit int32
}
