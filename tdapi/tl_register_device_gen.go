...
const RegisterDeviceRequestTypeID = 0xacd51c1b
...
func (r *RegisterDeviceRequest) Decode(b *bin.Buffer) error {
	if r == nil {
		return fmt.Errorf("can't decode registerDevice#acd51c1b to nil")
	}
	if err := b.ConsumeID(RegisterDeviceRequestTypeID); err != nil {
		return fmt.Errorf("unable to decode registerDevice#acd51c1b: %w", err)
	}
...
func (r *RegisterDeviceRequest) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode registerDevice#acd51c1b: field device_token: %w", err)
		}
		r.DeviceToken = value
	}
	{
		headerLen, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode registerDevice#acd51c1b: field other_user_ids: %w", err)
		}
...
func (r *RegisterDeviceRequest) DecodeTDLibJSON(b jsontd.Decoder) error {
	if r == nil {
		return fmt.Errorf("can't decode registerDevice#acd51c1b to nil")
	}
...
func (r *RegisterDeviceRequest) GetOtherUserIDs() (value []int32) {
	return r.OtherUserIDs
}

// RegisterDevice invokes method registerDevice#acd51c1b returning error if any.
