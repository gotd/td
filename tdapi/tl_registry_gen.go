...
func TypesMap() map[uint32]string {
	return map[uint32]string{
		...
		StarTransactionPartnerUserTypeID:                              "starTransactionPartnerUser#bf9b5805",
		StarTransactionPartnerChannelTypeID:                           "starTransactionPartnerChannel#6ddac2f4",
		...
		SearchPublicStoriesByTagRequestTypeID:                         "searchPublicStoriesByTag#aa501062",
		...
		GetStarTransactionsRequestTypeID:                              "getStarTransactions#eb1e109d",
...
func ClassConstructorsMap() map[string][]uint32 {
	return map[string][]uint32{
		...
		StarTransactionPartnerClassName: {
			...
			StarTransactionPartnerChannelTypeID,
