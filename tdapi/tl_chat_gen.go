...
// Chat represents TL type `chat#69d332bd`.
type Chat struct {
...
func (c *Chat) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode chat#69d332bd as nil")
	}
	b.PutID(ChatTypeID)
...
func (c *Chat) EncodeBare(b *bin.Buffer) error {
	...
	for idx, v := range c.Positions {
		if err := v.EncodeBare(b); err != nil {
			return fmt.Errorf("unable to encode bare chat#69d332bd: field positions element with index %d: %w", idx, err)
		}
	}
	if c.MessageSenderID == nil {
...
func (c *Chat) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode chat#69d332bd to nil")
	}
	if err := b.ConsumeID(ChatTypeID); err != nil {
		return fmt.Errorf("unable to decode chat#69d332bd: %w", err)
	}
...
func (c *Chat) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field id: %w", err)
		}
		c.ID = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field type: %w", err)
		}
		c.Type = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field title: %w", err)
		}
		c.Title = value
	}
	{
		if err := c.Photo.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field photo: %w", err)
		}
	}
	{
		if err := c.Permissions.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field permissions: %w", err)
		}
	}
	{
		if err := c.LastMessage.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field last_message: %w", err)
		}
	}
	{
		headerLen, err := b.Int()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field positions: %w", err)
		}
		...
		for idx := 0; idx < headerLen; idx++ {
			...
			if err := value.DecodeBare(b); err != nil {
				return fmt.Errorf("unable to decode bare chat#69d332bd: field positions: %w", err)
			}
	...
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field message_sender_id: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field has_protected_content: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field is_marked_as_unread: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field is_blocked: %w", err)
		}
		c.IsBlocked = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field has_scheduled_messages: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field can_be_deleted_only_for_self: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field can_be_deleted_for_all_users: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field can_be_reported: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field default_disable_notification: %w", err)
		}
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field unread_count: %w", err)
		}
		c.UnreadCount = value
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field last_read_inbox_message_id: %w", err)
		}
	...
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field last_read_outbox_message_id: %w", err)
		}
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field unread_mention_count: %w", err)
		}
		c.UnreadMentionCount = value
	}
	{
		if err := c.NotificationSettings.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field notification_settings: %w", err)
		}
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field message_ttl: %w", err)
		}
		c.MessageTTL = value
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field theme_name: %w", err)
		}
		c.ThemeName = value
	}
	{
		...
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field action_bar: %w", err)
		}
		c.ActionBar = value
	}
	{
		if err := c.VideoChat.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field video_chat: %w", err)
		}
	}
	{
		if err := c.PendingJoinRequests.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field pending_join_requests: %w", err)
		}
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field reply_markup_message_id: %w", err)
		}
		c.ReplyMarkupMessageID = value
	}
	{
		if err := c.DraftMessage.Decode(b); err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field draft_message: %w", err)
		}
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode chat#69d332bd: field client_data: %w", err)
		}
		c.ClientData = value
	}
	return nil
