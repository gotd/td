...
// MessageChatSetTTL represents TL type `messageChatSetTtl#49e6b31b`.
...
const MessageChatSetTTLTypeID = 0x49e6b31b
...
func (m *MessageChatSetTTL) Encode(b *bin.Buffer) error {
	if m == nil {
		return fmt.Errorf("can't encode messageChatSetTtl#49e6b31b as nil")
	}
...
func (m *MessageChatSetTTL) Decode(b *bin.Buffer) error {
	if m == nil {
		return fmt.Errorf("can't decode messageChatSetTtl#49e6b31b to nil")
	}
	if err := b.ConsumeID(MessageChatSetTTLTypeID); err != nil {
		return fmt.Errorf("unable to decode messageChatSetTtl#49e6b31b: %w", err)
	}
	return m.DecodeBare(b)
}
...
func (m *MessageChatSetTTL) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode messageChatSetTtl#49e6b31b: field ttl: %w", err)
		}
		m.TTL = value
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode messageChatSetTtl#49e6b31b: field from_user_id: %w", err)
		}
		m.FromUserID = value
	}
	return nil
...
func (m *MessageChatSetTTL) GetFromUserID() (value int64) {
	if m == nil {
		return
	}
	return m.FromUserID
...
// MessageGiftedPremium represents TL type `messageGiftedPremium#5e392899`.
...
const MessageGiftedPremiumTypeID = 0x5e392899
...
func (m *MessageGiftedPremium) Encode(b *bin.Buffer) error {
	if m == nil {
		return fmt.Errorf("can't encode messageGiftedPremium#5e392899 as nil")
	}
...
func (m *MessageGiftedPremium) EncodeBare(b *bin.Buffer) error {
	...
	if err := m.Sticker.Encode(b); err != nil {
		return fmt.Errorf("unable to encode messageGiftedPremium#5e392899: field sticker: %w", err)
	}
	return nil
}
...
func (m *MessageGiftedPremium) Decode(b *bin.Buffer) error {
	if m == nil {
		return fmt.Errorf("can't decode messageGiftedPremium#5e392899 to nil")
	}
	if err := b.ConsumeID(MessageGiftedPremiumTypeID); err != nil {
		return fmt.Errorf("unable to decode messageGiftedPremium#5e392899: %w", err)
	}
	return m.DecodeBare(b)
}
...
func (m *MessageGiftedPremium) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.String()
		if err != nil {
			return fmt.Errorf("unable to decode messageGiftedPremium#5e392899: field currency: %w", err)
		}
		m.Currency = value
	}
	{
		value, err := b.Int53()
		if err != nil {
			return fmt.Errorf("unable to decode messageGiftedPremium#5e392899: field amount: %w", err)
		}
		m.Amount = value
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode messageGiftedPremium#5e392899: field month_count: %w", err)
		}
		m.MonthCount = value
	}
	{
		if err := m.Sticker.Decode(b); err != nil {
			return fmt.Errorf("unable to decode messageGiftedPremium#5e392899: field sticker: %w", err)
		}
	}
	return nil
}
...
//	case *tdapi.MessageChatSetTTL: // messageChatSetTtl#49e6b31b
...
func DecodeMessageContent(buf *bin.Buffer) (MessageContentClass, error) {
	...
	case MessageChatSetTTLTypeID:
		// Decoding messageChatSetTtl#49e6b31b.
		v := MessageChatSetTTL{}
		if err := v.Decode(buf); err != nil {
			return nil, fmt.Errorf("unable to decode MessageContentClass: %w", err)
		}
	...
	case MessageGiftedPremiumTypeID:
		// Decoding messageGiftedPremium#5e392899.
